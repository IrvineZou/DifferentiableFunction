...
class NodeFormerConv(gnn.MessagePassing):
    ...
    def forward(self, z, adjs, tau, sat=0):
        ...
        out = self.propagate(adjs, v=v, qk=qk, edge_attr=None, size=None,
                                 return_attn=False)
...
class dag_nodeformer(nn.Module):
    ...
    '''
    def __init__(self, in_channels, hidden_channels, out_channels, num_layers=1, num_heads=8, dropout=0.0,
